...
int get_bloom_size(void){
  return hash_bloom_size;
}

//Initializes the hash table
HTable hash_initialize(int bloom){

  hash_bloom_size = bloom;
...
HNode new_hash_node(char** item){
  ...
  //Initialize filters
  temp->vaccinated = new_bloom_filter(hash_bloom_size);
  temp->unvaccinated = new_bloom_filter(hash_bloom_size);
